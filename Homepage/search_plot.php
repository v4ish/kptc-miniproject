...
<head>
    ...
    <title>Search For Plot/Land</title>
...
if (!isset($_SESSION['user'])) {
   ...
   ?>
    ...
    <div class="search-wrapper">
        <label for="search">Search for Plot/land</label>
        ...
        <div class="box-container">
            <div class="box">
                ...
                <div class="thumb">
                    ...
                    <p class="type"><span>Plot</span><span>sale</span></p>
                    <img src="re/aaliya/plot1.jpg" alt="" />
                </div>
                <h3 class="name">10 L /Cent near nedumbassery </h3>
                <p class="location">
                    <i class="fas fa-map-marker-alt"></i><span>Nedumbassery , Kochi - 683585</span>
                </p>
                <div class="flex">
                    <p><i class="fas fa-rupee-sign"></i><span>1 Cr</span></p>
                    <p><i class="fas fa-maximize"></i><span>10 cent</span></p>
                </div>
            ...
            <div class="box">
                ...
                <div class="thumb">
                    ...
                    <img src="re/adhithyan/plot1.jpg" alt="" />
                </div>
                <h3 class="name">Plot for rent in Haripad</h3>
                <p class="location">
                    <i class="fas fa-map-marker-alt"></i><span>Haripad, Allapuzha - 690514</span>
                </p>
                <div class="flex">
                    <p><i class="fas fa-rupee-sign"></i><span>40 L</span></p>
                    <p><i class="fas fa-maximize"></i><span>9 Cent</span></p>
                </div>
                <a href="tel:+918714899350" class="btn">Call</a>
            ...
            <div class="box">
                ...
                <div class="thumb">
                    ...
                    <p class="type"><span>House</span><span>sale</span></p>
                    <img src="re/vaisakh/plot1.jpg" alt="" />
                </div>
                <h3 class="name">Plot for sale near Aster medicity</h3>
                <p class="location">
                    <i class="fas fa-map-marker-alt"></i><span>South Chittoor, Kochi - 682027</span>
                </p>
                <div class="flex">
                    <p><i class="fas fa-rupee-sign"></i><span>52 L</span></p>
                    <p><i class="fas fa-maximize"></i><span>7.8 cent</span></p>
                </div>
                <a href="tel:+918714899350" class="btn">Call</a>
                <a href="mailto:thevk350@proton.me" class="btn">Mail</a>
            </div>
